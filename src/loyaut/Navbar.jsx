...
// import NavbarTop from './conponents/NavbarTop'
...
function Navbar() {
    ...
    return (
        <nav className={` border border-gray-200 sticky top-0  left-0 bg-white z-50 `}>
            <div className=' py-4'>
                <div className=' flex flex-row items-center justify-between px-20 py-3'>
                    ...
                    <div className=' flex flex-row gap-5 items-center justify-center'>
                        <button className=' font-sans font-medium text-[15px] hover:bg-[#eeeeeec3] rounded-[30px] px-4 py-2'>Сдать жилье на Airbnb</button>
                        <FiGlobe className='hover:bg-[#eeeeeec3]  ' />
                        <button className=' w-[85px]  flex items-center justify-center  rounded-[30px] gap-2 border border-zinc-300 py-[5.5px] px-3 hover:shadow shadow-gray-300 transition'>
                            <TfiAlignJustify />
                            <img className='w-9 h-9 rounded-full' src="https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg" alt="" />
                        </button>
                    </div>

                </div>
                {/* <div className={`  ${   scrollPosition < 64 ? '':'-mt-16'} w-[800px] h-16  rounded-[40px] m-auto mb-1  shadow shadow-zinc-300 flex flex-row justify-between items-center `}>

                    <label
                        onMouseEnter={() => setIconVisible(true)}
                        onMouseLeave={() => setIconVisible(false)}
                        className=' flex flex-col hover:bg-[#efefefd4] h-full w-full justify-center  rounded-[30px] cursor-pointer '>
                        <div className={` flex flex-col w-full pl-5`}>
                            <span className='text-xs font-bold '>

                                Где
                            </span>
                            <input type="date" className=' text-[15px] text-[#7a7a7a] bg-transparent outline-none' placeholder='Прибытие hhриб' />
                        </div>
                    </label>
                    <div
                        onMouseEnter={() => setIconVisible2(true)}
                        onMouseLeave={() => setIconVisible2(false)}
                        className=' flex flex-col hover:bg-[#efefefd4] h-full w-full justify-center  rounded-[30px] cursor-pointer '>
                        <div className={` border-l border-zinc-300 ${iconVisible2 ? 'border-none' : ""} ${iconVisible ? 'border-none' : ""} flex flex-col w-full  pl-5`}>
                            <h1 className=' text-xs font-bold'>Прибытие</h1>
                            <h1 className=' text-[#7a7a7a]'>Когда?</h1>
                        </div>
                    </div>
                    <div
                        onMouseEnter={() => setIconVisible3(true)}
                        onMouseLeave={() => setIconVisible3(false)}
                        className=' flex flex-col hover:bg-[#efefefd4] h-full w-full justify-center  rounded-[30px] cursor-pointer '>
                        <div className={` border-l border-zinc-300 ${iconVisible3 ? 'border-none' : ""} ${iconVisible2 ? 'border-none' : ""} flex flex-col w-full `}>
                            <h1 className='text-xs font-bold pl-5 '>Выезд</h1>
                            <h1 className='text-[#7a7a7a] pl-5 '>Когда?</h1>
                        </div>
                    </div>
                    <div
                        onMouseEnter={() => setIconVisible4(true)}
                        onMouseLeave={() => setIconVisible4(false)}
                        className='flex items-center justify-center gap-20 h-full w-full  hover:bg-[#efefefd4]  rounded-[30px]'>
                        
                        <div className={` border-l border-zinc-300 ${iconVisible3 ? 'border-none' : ""} ${iconVisible4 ? 'border-none' : ""} flex flex-row w-full justify-between px-5 items-center `}>

                            <div className=' flex flex-col '>
                                <h1 className=' text-xs font-bold'>Кто</h1>
                                <h1 className=' text-[#7a7a7a]'>Кто едет?</h1>
                            </div>
                            <div className=' w-12 h-12 -mr-3 rounded-full bg-[#ff003ce4] hover:bg-[#da1b47e1] flex items-center justify-center'>
                                <IoSearchSharp className=' text-xl  text-white font-bold  ' />
                            </div>
                        </div>
                    </div>
                </div> */}
            ...
            <div className='  w-full h-20 border border-zinc-200 px-[88px] flex flex-row items-center'>
                <div className=' flex  flex-shrink-0 gap-8 items-center jc  w-[900px]  h-full  '>

                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <MdKitesurfing className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Серфинг</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <PiBuildingsLight className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Дизайн</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <FaMountainCity className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Национальные парки</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <PiCastleTurret className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Замки</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <GiIsland className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Острова</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <AiOutlineApartment className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Каса партикуляр</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <BsShop className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Минсу</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <FaCaravan className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Автодома</h1>
                    </div>
                    <div className=' flex flex-col gap-1 items-center justify-center hover:text-black cursor-pointer font-mono font-bold text-[#737373] '>
                        <IoSnowOutline className=' text-2xl    ' />
                        <h1 className=' text-sm    '>Арктика</h1>
                    </div>
            
                </div>

                <div className='  w-full h-full flex  items-center  gap-4 '>
                    <button className=' text-xl border border-zinc-400 rounded-full p-[3px] flex items-center justify-center hover:shadow-lg hover:shadow-zinc-300 transition duration-300  hover:p-1 '><CgChevronRight className=' pr-1   font-bold ' /></button>
                    <button className=' py-3 px-4 border border-zinc-300 rounded-xl flex flex-row items-center justify-center gap-2' >
                        <LuSettings2 />
